...
public class TestModel{
	...
	public void test2Opt() throws FileNotFoundException{
		...
		//System.out.println("Pre 2opt distance: " + distance);
		m.twoOpt();
		//System.out.println("Post 2opt distance: " + m.bestTripDistance);
		assertEquals(2528,distance);
		assertEquals(2316,m.bestTripDistance);
	}
